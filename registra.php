                ...
                <?php
                    if ('POST' == $_SERVER['REQUEST_METHOD']) {
                        ...
                        $validation = $validator->make($_POST, [
                            ...
                            , 'perfil' => 'required|in:Empleado,Usuario'
...
fin;
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perfil" id="perfil1" value="Empleado" <?php echo 'Empleado' == ($_POST['perfil'] ?? '') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="perfil1">
                                        Empleado
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perfil" id="perfil2" value="Usuario" <?php echo 'Usuario' == ($_POST['perfil'] ?? '') ? 'checked' : '' ?>>
