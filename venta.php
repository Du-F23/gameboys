...
<div class="mb-3">
  <label for="formGroupExampleInput" class="form-label">Videojuego</label>
  <input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="Videojuego"> 
</div>
<div class="mb-3">
...
Si deseas <strong><a href="intercambio.php"> Intercambiar algun juego</a></strong>  , o si bien lo deseas puedes <strong><a href="comprar.php">Comprar</a></strong>
</div>
